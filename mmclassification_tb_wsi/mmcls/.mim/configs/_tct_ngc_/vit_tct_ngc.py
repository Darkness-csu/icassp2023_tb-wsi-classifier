_base_ = [
    '../_base_/models/vit-base-p16-tct.py',
...
dataset_type = 'TCT'
data_root = '../../../commonfile/processed/TCT_NGC_DETR_961/new_smear_cls_head_v4_full/'
train_pipeline = [
...
work_dir = 'new_work_dirs/vit_tct_ngc/new_cls_head_v4'
