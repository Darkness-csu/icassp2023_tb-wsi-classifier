...
def parse_args():
    ...
    parser.add_argument('--input', default='../data/TCT/annotations/test_smear.json')
    parser.add_argument('--output', default='../data/TCT/smear/')
...
def main():
    ...
    gpu_test_and_save(model, data_loader, output_root=args.output, distributed=distributed)
