...
PROCESSED_ROOT = '../../../commonfile/processed/TCT_NGC/fs_faster_smear/'
INPUTS_LIST = [
    ROOT + 'TCT_NGC-BJXK-20210910',
    ROOT + 'Annotated20211207XIMEATCT-FFK--FYB-12358',
    ROOT + 'Annotated20211207XIMEATCT-FFK--FYB_WSI',
    ROOT + 'Annotated20220209XIMEATCT-FFK---10294',
    ROOT + 'Annotated20220212XIMEATCT-FFK--FYB',
    ROOT + 'Unannotated20220629HBSYYTCT-FFK-238'
]
classes_name_to_id = {
    #'mesothelial_cell': 1,
    # 'blood_cell': 0,
...
def parse_args():
    ...
    parser.add_argument('--output', type=str, default='../data/TCT_NGC/annotations/fs_faster_test_smear.json')
