...
def parse_args():
    ...
    parser.add_argument('--input', type=str, default='../../../commonfile/processed/TCT/smear_full/full')
    parser.add_argument('--output', type=str, default='../../../commonfile/processed/TCT/smear_full/')
