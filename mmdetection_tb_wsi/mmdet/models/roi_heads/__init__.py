...
from .deformdetr_cls_head import CLS_Head
from .deformdetr_cls_head_v2 import CLS_Head_V2
from .deformable_cls_head_v3 import CLS_Head_V3
from .deformable_cls_head_v4 import CLS_Head_V4
from .deformable_cls_head_supcon_v1 import CLS_Head_SupCon_V1
from .deformable_cls_head_moco_v1 import CLS_Head_MoCo_V1
__all__ = [
    ...
    'FeatureRelayHead', 'GlobalContextHead','CLS_Head','CLS_Head_V2','CLS_Head_V3',
    'CLS_Head_V4','CLS_Head_SupCon_V1','CLS_Head_MoCo_V1'
]
